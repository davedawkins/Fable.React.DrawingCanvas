...
exports.default = exports.defaultCancellationToken = exports.Async = void 0;
...
function catchAsync(work) {
  return (0, _AsyncBuilder.protectedCont)(ctx => {
    work({
      onSuccess: x => ctx.onSuccess((0, _Option.choice1Of2)(x)),
      onError: ex => ctx.onSuccess((0, _Option.choice2Of2)(ex)),
