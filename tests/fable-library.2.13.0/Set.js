...
function SetTree$00601$reflection($gen$$3) {
  return (0, _Reflection.union_type)("Set.SetTree`1", [$gen$$3], SetTree$00601, () => ["SetEmpty", ["SetNode", [["Item1", $gen$$3], ["Item2", SetTree$00601$reflection($gen$$3)], ["Item3", SetTree$00601$reflection($gen$$3)], ["Item4", _Reflection.int32_type]]], ["SetOne", [["Item", $gen$$3]]]]);
}
...
function SetTreeModule$$$$007CMatchSetNode$007CMatchSetEmpty$007C(s$$6) {
  switch (s$$6.tag) {
    ...
    case 0:
      {
        return new _Option.Choice(1, "Choice2Of2", void null);
      }
...
const SetTreeModule$002ESetIterator$00601 = (0, _Types.declare)(function Set_SetTreeModule_SetIterator(stack, started) {
  this.stack = stack;
...
function SetTreeModule$002ESetIterator$00601$reflection($gen$$103) {
  return (0, _Reflection.record_type)("Set.SetTreeModule.SetIterator`1", [$gen$$103], SetTreeModule$002ESetIterator$00601, () => [["stack", (0, _Reflection.list_type)(SetTree$00601$reflection($gen$$103))], ["started", _Reflection.bool_type]]);
}
...
function SetTreeModule$002EmkIEnumerator$00601$reflection($gen$$108) {
  return (0, _Reflection.class_type)("Set.SetTreeModule.mkIEnumerator`1", [$gen$$108], SetTreeModule$002EmkIEnumerator$00601);
}
...
function FSharpSet$reflection($gen$$133) {
  return (0, _Reflection.class_type)("Set.FSharpSet", [$gen$$133], FSharpSet);
}
...
function createMutable(source, comparer$$31) {
  const set = (0, _MutableSet.MutableSet$00601$$$$002Ector$$Z6150332D)(source, comparer$$31);
  return set;
}

function distinct(xs, comparer$$32) {
  return (0, _Seq.delay)(function () {
    const set$$1 = (0, _MutableSet.MutableSet$00601$$$$002Ector$$Z6150332D)((0, _Seq.empty)(), comparer$$32);
    return (0, _Seq.collect)(function (x$$33) {
      return (0, _MutableSet.MutableSet$00601$$Add$$2B595)(set$$1, x$$33) ? (0, _Seq.singleton)(x$$33) : (0, _Seq.empty)();
    }, xs);
  });
}
...
function distinctBy(projection, xs$$1, comparer$$33) {
  return (0, _Seq.delay)(function () {
    const set$$2 = (0, _MutableSet.MutableSet$00601$$$$002Ector$$Z6150332D)((0, _Seq.empty)(), comparer$$33);
    return (0, _Seq.collect)(function (x$$34) {
      return (0, _MutableSet.MutableSet$00601$$Add$$2B595)(set$$2, projection(x$$34)) ? (0, _Seq.singleton)(x$$34) : (0, _Seq.empty)();
    }, xs$$1);
  });
}

function unionWith(s1$$4, s2$$4) {
  return (0, _Seq.fold)(function folder(acc$$14, x$$35) {
